        ...
        <section className="border-b border-gray-200 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4 py-16 md:py-24">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              ...
              <a href="/tools/build-vs-buy" className="inline-flex items-center justify-center gap-2 px-7 py-4 border border-gray-900 text-gray-900 text-sm md:text-base hover:bg-gray-900 hover:text-white transition">Not sure which? Take the quiz</a>
            </div>
          </div>
        </section>
